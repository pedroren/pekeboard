...
.union(
    ...
    CAG.circle({"center":[109.5,-91.5],"radius":3.5})
                ...
                // creating part 2 of case _wall
                let _wall__part_2 = _holes_case_fn();

                // make sure that rotations are relative
                let _wall__part_2_bounds = _wall__part_2.getBounds();
                let _wall__part_2_x = _wall__part_2_bounds[0].x + (_wall__part_2_bounds[1].x - _wall__part_2_bounds[0].x) / 2
                let _wall__part_2_y = _wall__part_2_bounds[0].y + (_wall__part_2_bounds[1].y - _wall__part_2_bounds[0].y) / 2
                _wall__part_2 = translate([-_wall__part_2_x, -_wall__part_2_y, 0], _wall__part_2);
                _wall__part_2 = rotate([0,0,0], _wall__part_2);
                _wall__part_2 = translate([_wall__part_2_x, _wall__part_2_y, 0], _wall__part_2);

                _wall__part_2 = translate([0,0,0], _wall__part_2);
                result = result.subtract(_wall__part_2);
                ...
                let case__part_1 = sandwich_case_case_fn();
